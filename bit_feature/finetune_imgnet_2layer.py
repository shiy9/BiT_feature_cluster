...
lr = 1e-2
stepSize = 15
save_name = 'finetune2l_inet_temp'
# Number of workers
...
for val_folder_index in range(train_splits):
    ...
    best_models.append(f'train_all_{best_split}_epoch_{best_epoch}_l1.pth')
    best_models.append(f'train_all_{best_split}_epoch_{best_epoch}_l2.pth')
